...
class PhraseConfig:
    ...
    If ``None``, defaults to the payments / iGaming seed block in
    ``glossary_builder.domain_data.payments_igaming.phrase_seed_block``.
...
class PipelineConfig:
    ...
    domain_brief: str = (
        "A multilingual Telegram group focused on payment processing (PSPs, "
        "acquiring, merchant accounts) for high-risk verticals: iGaming, online "
        "casinos, sportsbooks, forex, crypto, adult, nutra. Participants are "
        "industry insiders — payment professionals, affiliates, casino operators, "
        "PSP sales reps. Messages are in Russian, Ukrainian, and English, often "
        "mixed within a single message. Common jargon: FTD, STD, MID, MCC, KYC, "
        "AML, CB, and their Russian/Ukrainian equivalents."
    )
